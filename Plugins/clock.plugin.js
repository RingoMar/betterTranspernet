...
clockPlugin.prototype.start = function () {
	...
	BdApi.injectCSS("clockPluginCss", '#clockPluginClock { position:absolute; color:#FFF; background:#333333; padding:0 12px 0 12px; min-width:5opx; max-width:50px; z-index:100; }');
	var self = this;
